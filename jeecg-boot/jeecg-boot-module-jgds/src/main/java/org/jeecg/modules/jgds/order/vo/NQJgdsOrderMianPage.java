 ...
 */
@Data
@ApiModel(value="jgds_order_mianPage对象", description="NQ商品订单")
public class NQJgdsOrderMianPage {
	...
	@ExcelCollection(name="NQ订单商品")
	@ApiModelProperty(value = "NQ订单商品")
	private List<NQJgdsOrderGoods> nQJgdsOrderGoodsList;
	@ExcelCollection(name="NQ订单客户")
	@ApiModelProperty(value = "NQ订单客户")
	private List<NQJgdsOrderCustom> nQJgdsOrderCustomList;
