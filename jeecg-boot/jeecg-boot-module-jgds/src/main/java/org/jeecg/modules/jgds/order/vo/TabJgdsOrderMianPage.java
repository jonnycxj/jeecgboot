 ...
 */
@Data
@ApiModel(value="jgds_order_mianPage对象", description="Tab商品订单")
public class TabJgdsOrderMianPage {
	...
	@ExcelCollection(name="Tab订单商品")
	@ApiModelProperty(value = "Tab订单商品")
	private List<TabJgdsOrderGoods> tabJgdsOrderGoodsList;
	@ExcelCollection(name="Tab订单客户")
	@ApiModelProperty(value = "Tab订单客户")
	private List<TabJgdsOrderCustom> tabJgdsOrderCustomList;
