        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="商品分类" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="goodTypeId">
                ...
                dict="jgds_ces_shop_type,name,id"
                pidValue="0"
                >
              </j-tree-select>
            </a-form-model-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/goods/jgdsCesShopGood/add",
          edit: "/goods/jgdsCesShopGood/edit",
          queryById: "/goods/jgdsCesShopGood/queryById"
        }
      }
    },
    computed: {
