  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/order/eRPJgdsOrderMian/addERPJgdsOrderCustom",
          edit: "/order/eRPJgdsOrderMian/editERPJgdsOrderCustom",
        }
      ...
      handleOk () {
        ...
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            this.model['orderMainId'] = this.mainId
